...
// Expone las operaciones relacionadas con el inicio de sesión administrativo.
public class AuthController {
    ...
    @PostMapping("/login")
    // Valida las credenciales, crea la autenticación y la guarda en la sesión HTTP.
    ...
    public record LoginRequest(String email, String password) {
        // Representa las credenciales recibidas desde el formulario de login.
    }
}
